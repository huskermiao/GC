...
example:
python cleanup.py -i input_file -o output_file'''
...
optparser.add_option('-a', '--ref_gt', dest = 'ref_genotype',default='A',
                     help = "Homozygous 0/0 genotype letter in your genotype \n\
                     matrix file. Default is 'A'.")
optparser.add_option('-b', '--alt_gt', dest = 'alt_genotype',default = 'B',
                     help = "Homozygous 1/1 genotype letter in your genotype \n\
                     matrix file. Default is 'B'.")
optparser.add_option('-x', '--hetero_gt', dest = 'heterozygous_genotype',default = 'X',
                     help = "Heterozygous genotype letter in your genotype \n\
                     matrix file. Default is'X'.")
optparser.add_option('-c', '--miss_gt', dest = 'missing_data_character',default = '-',
                     help = "Missing data character in your genotype \n\
                     matrix file. Default is '-'.")
